...
<section>
   ...
   <br>
    <div class="box1">
      ...
      <form  name="login" action="" method="post">
        ...
        <b><p style="padding-left:50px; font-size:15px;font-weight:700;">Login as:</b>
      ...
      <p style="color: white; padding-left: 30px; text-align:center;">
        <br><br>
  ...
  <?php
    ...
    if(isset($_POST['submit'])){
      if($_POST['user']=='admin'){
          $count=0;
          $res=mysqli_query($db,"SELECT * FROM `admin` WHERE username='$_POST[username]' and password='$_POST[password]' and status='approved';");
          ...
          if($count==0){
            ?>
              <div class="alert alert-danger" style="width: 600px; margin-left: 370px; background-color: #de1313; color: white">
                <strong>This user is not approved yet.</strong>
              </div>    
            <?php
          }
          else
