...
<!------------------REQUEST BOOK----------------------->
	...
	<?php
		...
		echo "<table class='table table-bordered table-hover' >";
			echo "<tr style='	background-color: #24989ce6;'>";
				//Table header
				echo "<th>"; echo "ID";	echo "</th>";
				echo "<th>"; echo "Book-Name";  echo "</th>";
				echo "<th>"; echo "Authors Name";  echo "</th>";
		...
		if(isset($_POST['submit1'])){
			$sql1=mysqli_query($db,"SELECT * FROM `books` WHERE book_id='$_POST[book_id]' and status='available';" );
			...
			if($count1!=0){
				...
				?>
					<script type="text/javascript">
						alert("Sorry, the book you have requested in unavailable.");
					</script>
				<?php
			}
		}
