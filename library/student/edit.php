...
<body style="background-color: #24989ce6;">
    ...
    <div class="form1">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input class="form-control" type="text" name="rollno" value="<?php echo htmlspecialchars($rollno); ?>">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql1 = "UPDATE student SET pic='$pic', firstname='$firstname', lastname='$lastname', username='$username', password='$password', email='$email', rollno='$rollno', phone='$phone' WHERE username='$_SESSION[login_user]';";
