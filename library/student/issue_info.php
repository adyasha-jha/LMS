        ...
        <div class="container">
			...
			$c=0;
                 if(isset($_SESSION['login_user'])){
					$sql="SELECT student.username, rollno, books.book_id, name, authors, edition, issue_date, issue_book.return_date FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.book_id=books.book_id WHERE issue_book.approve='Yes' and issue_book.username='$_SESSION[login_user]' ORDER BY `issue_book`.`return_date` ASC";
